...
public class SearchJsonPathExample {
    ...
    @Test
    public void test004() {
        //homework---data[0].categories--list
        List<HashMap<String,?>> categories = response.extract().path("data[0].categories");
    ...
    @Test
    public void test008() {
        List<Integer> productprice = response.extract().path("  data.findAll{it.name=='Duracell - D Batteries (4-Pack)'}.price");

        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The price of product name 'Duracell - D Batteries (4-Pack)' is : "+productprice);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test009() {
        ...
        List<Integer> productname = response.extract().path("  data.findAll{it.price<16.99}.name");
        System.out.println("------------------StartingTest---------------------------");
    ...
    public void test010() {
        //response.log().all();
        List<String> manufacturer = response.extract().path("  data.findAll{it.name=~/Ene.*/}.manufacturer");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The manufacturer of products whose name Start = McV are: "+manufacturer);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test011() {
        List<String> price1 = response.extract().path("  data.findAll{it.name=~/.*Vehicles/}.manufacturer");
